...
func (x *Greetings) GetFirstName() string {
	if x != nil {
		return x.FirstName
	}
	return ""
...
func (x *Greetings) GetLastName() string {
	if x != nil {
		return x.LastName
	}
	return ""
...
type GreetRequest struct {
	...
	Greeting *Greetings `protobuf:"bytes,1,opt,name=greeting,proto3" json:"greeting,omitempty"`
}
...
func (x *GreetRequest) GetGreeting() *Greetings {
	if x != nil {
		return x.Greeting
	}
	return nil
...
func (x *GreetManyTimesRequest) GetGreeting() *Greetings {
	if x != nil {
		return x.Greeting
	}
	return nil
...
var file_greet_greetpb_greet_proto_rawDesc = []byte{
	...
	0x65, 0x74, 0x22, 0x47, 0x0a, 0x09, 0x47, 0x72, 0x65, 0x65, 0x74, 0x69, 0x6e, 0x67, 0x73, 0x12,
	...
	0x72, 0x65, 0x65, 0x74, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x2c, 0x0a, 0x08, 0x67,
	0x72, 0x65, 0x65, 0x74, 0x69, 0x6e, 0x67, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x10, 0x2e,
	0x67, 0x72, 0x65, 0x65, 0x74, 0x2e, 0x47, 0x72, 0x65, 0x65, 0x74, 0x69, 0x6e, 0x67, 0x73, 0x52,
	...
	0x01, 0x28, 0x09, 0x52, 0x06, 0x72, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x32, 0x97, 0x01, 0x0a, 0x0c,
	...
	0x22, 0x00, 0x12, 0x51, 0x0a, 0x0e, 0x47, 0x72, 0x65, 0x65, 0x74, 0x4d, 0x61, 0x6e, 0x79, 0x54,
	...
	0x65, 0x22, 0x00, 0x30, 0x01, 0x42, 0x11, 0x5a, 0x0f, 0x2e, 0x2f, 0x67, 0x72, 0x65, 0x65, 0x74,
...
var file_greet_greetpb_greet_proto_goTypes = []interface{}{
	(*Greetings)(nil),              // 0: greet.Greetings
...
var file_greet_greetpb_greet_proto_depIdxs = []int32{
	0, // 0: greet.GreetRequest.greeting:type_name -> greet.Greetings
	0, // 1: greet.GreetManyTimesRequest.greeting:type_name -> greet.Greetings
